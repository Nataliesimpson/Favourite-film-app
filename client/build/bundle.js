...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilmsList = __webpack_require__(161);
	var FilmsForm = __webpack_require__(163);
	...
	var sampleData = [{ id: 1, name: "Life on the road", rating: "10/10" }, { id: 2, name: "Captain Fantastic", rating: "7/10" }, { id: 3, name: "The man who fell to earth", rating: "9/10" }, { id: 4, name: "Don't breathe", rating: "3/10" }];
	...
	var FilmsBox = React.createClass({
	  ...
	  handleFilmDelete: function handleFilmDelete(id) {
	  ...
	  handleFilmSubmit: function handleFilmSubmit(film) {
	    film.id = Date.now();
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(FilmsList, { data: this.state.data, handleFilmDelete: this.handleFilmDelete }),
	      React.createElement(FilmsForm, { handleFilmSubmit: this.handleFilmSubmit })
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Film = __webpack_require__(162);
	...
	var FilmsList = React.createClass({
	  ...
	  render: function render() {
	    var filmNodes = this.props.data.map(function (film) {
	      return React.createElement(
	        Film,
	        { name: film.name, id: film.id, key: film.id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilmsForm = React.createClass({
	  ...
	  handleRatingChange: function handleRatingChange(e) {
	  ...
	  render: function render() {
	    return React.createElement(
	      'form',
	      { className: 'film-form', onSubmit: this.handleSubmit },
	      React.createElement('input', { type: 'name', placeholder: 'Film name',
	        value: this.state.name,
	        onChange: this.handleNameChange
	      }),
	      React.createElement('input', { type: 'rating', placeholder: 'Add rating',
	        value: this.state.rating,
	        onChange: this.handleRatingChange
	      }),
	      React.createElement('input', { type: 'submit', value: 'Add film' })
	    );
	  }
